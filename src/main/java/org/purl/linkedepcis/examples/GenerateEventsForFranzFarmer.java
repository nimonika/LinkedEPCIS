...
public class GenerateEventsForFranzFarmer {
	...
	public GenerateEventsForFranzFarmer() {
		...
		ns.setIRIandPrefix("addresses/id/", "addr2");
		ns.setIRIandPrefix("readers/id/", "rdr2");
		ns.setIRIandPrefix("epc/id/events/", "eve");
		ns.setIRIandPrefix("epc/id/sgtin", "epc");
		ns.setIRIandPrefix("readers/id/", "rdr");
		ns.setIRIandPrefix("epc/id/sgln/", "loc");
		ns.setIRIandPrefix("transactions/po/bt/id/", "tpo");
	    ns.setIRIandPrefix("transactions/desadv/bt/id/", "tpd");
		//setup namespaces for quantity event, EPCClass
		ns.setIRIandPrefix("epc/events/idpat/sgtin/id/", "qte");
